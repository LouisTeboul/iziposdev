app.config(['$translateProvider', function ($translateProvider) {
	...
	$translateProvider.translations('en_EN', {
        ...
        // For admin views
		"ADMIN.BOOKING.ACCEPT": "Accept",
		"ADMIN.BOOKING.ADDBOOKING": "Add Booking",
		"ADMIN.BOOKING.ADDRUNTIME": "Add Runtime",
		"ADMIN.BOOKING.APPLYCHANGE": "Apply change",
		"ADMIN.BOOKING.APPLYCHANGETO": "Apply change to ...",
		"ADMIN.BOOKING.AT": "at",
		"ADMIN.BOOKING.BOOKINGPLANNING": "Booking",
		"ADMIN.BOOKING.COMMENTS": "Comments",
		"ADMIN.BOOKING.CONFIRMED": "Confirmed",
		"ADMIN.BOOKING.DIVIDEPERIODS": "Divide the periods into slots",
		"ADMIN.BOOKING.EVENT": "Event",
		"ADMIN.BOOKING.GUESTS": "Guests",
		"ADMIN.BOOKING.GUESTSCOUNT": "Guests count",
		"ADMIN.BOOKING.GUESTSEVERY": "guests every",
		"ADMIN.BOOKING.INMINUTES": "in minutes",
		"ADMIN.BOOKING.MAXGUESTSCOUNT": "Max Guests count",
		"ADMIN.BOOKING.NEWBOOKING": "New Booking",
		"ADMIN.BOOKING.NUMBERGUESTSPERSLOT": "Number of guests per slot",
		"ADMIN.BOOKING.ONLYTHISONE": "This one only",
		"ADMIN.BOOKING.ONLYTHISWEEK": "Only this week",
		"ADMIN.BOOKING.OPTIONAL": "optional",
		"ADMIN.BOOKING.ORDERAMOUNT": "Order Amount",
		"ADMIN.BOOKING.PENDING": "Pending",
		"ADMIN.BOOKING.PRODUCTNAME": "Product",
		"ADMIN.BOOKING.REPEATEVERYWEEK": "Repeat every week",
		"ADMIN.BOOKING.SEARCHCUSTOMER": "Search Customer",
		"ADMIN.BOOKING.SLOTDURATION": "Duration of the slot",
		"ADMIN.BOOKING.STATUS": "Status",
		"ADMIN.BOOKING.THISONEANDNEXT": "This one and all next",
		"ADMIN.BOOKING.UPDATETHISANDALLNEXT": "Update this and all next",
		"ADMIN.BOOKING.UPDATETHISONLY": "Update this only",
		...
		"ADMIN.TELERIK.EDITORLOCALIZATION.CLOSE": "Close",
